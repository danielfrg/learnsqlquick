...
<SQLSection defaultValue={l4_q1} autoRun={true}></SQLSection>
...
<SQLSection defaultValue={l4_q2} autoRun={true}></SQLSection>
...
<SQLSection defaultValue={l4_q3} autoRun={true}></SQLSection>
